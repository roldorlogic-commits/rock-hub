...
/* ── Body content — z-index above watermark, below fixed header/footer ── */
.content {
...
async function generateItineraryPdf(ev, items) {
  ...
  try {
    ...
    return await page.pdf({
      ...
      // top matches body .ph height (62px band + 3px rule = 65px)
      // bottom matches body .pf height (50px)
      margin: { top: '65px', bottom: '50px', left: '0', right: '0' },
    });
  } finally {
    await page.close();
  }
