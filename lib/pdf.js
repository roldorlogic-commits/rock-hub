...
function buildHeaderTemplate(logoSrc) {
  return `<div style="width:100%;margin:0;padding:0;font-size:0;-webkit-print-color-adjust:exact;print-color-adjust:exact;">
  <div style="width:100%;height:62px;background-color:#14203a;display:flex;align-items:center;
              justify-content:space-between;padding:0 36px;box-sizing:border-box;">
    <div style="font-family:Georgia,'Times New Roman',serif;color:#ffffff;font-size:11px;
                font-weight:bold;letter-spacing:0.09em;text-transform:uppercase;line-height:1.4;flex:1;">
      The ROCK Association
      <span style="display:block;font-size:7.5px;font-weight:normal;color:#C9A96E;
                   letter-spacing:0.18em;margin-top:3px;">
        Recruiting &nbsp;&middot;&nbsp; Training &nbsp;&middot;&nbsp; Empowering
      </span>
    </div>
    <img src="${logoSrc}" style="height:46px;width:auto;display:block;flex-shrink:0;opacity:1;">
  </div>
  <div style="width:100%;height:3px;background-color:#C9A96E;font-size:0;"></div>
</div>`;
}

function buildFooterTemplate(logoSrc) {
  return `<div style="width:100%;margin:0;padding:0;font-size:0;-webkit-print-color-adjust:exact;print-color-adjust:exact;">
  <div style="width:100%;height:50px;background-color:#14203a;display:flex;align-items:center;
              justify-content:space-between;padding:0 28px;box-sizing:border-box;">
    <img src="${logoSrc}" style="height:30px;width:auto;display:block;flex-shrink:0;">
    <div style="color:#ffffff;font-family:Georgia,'Times New Roman',serif;font-size:7px;
                letter-spacing:0.05em;text-align:center;flex:1;padding:0 18px;line-height:1.4;">
      The Recruiters Of Christ&rsquo;s Kingdom Association
    </div>
    <div style="color:#ffffff;font-family:Georgia,'Times New Roman',serif;font-size:8px;
...
async function generateItineraryPdf(ev, items) {
  ...
  try {
    ...
    return await page.pdf({
      ...
      // Top margin = 62px header + 3px gold rule + 9px breathing room
      // Bottom margin = 50px footer + 6px breathing room
      margin: { top: '74px', bottom: '56px', left: '0', right: '0' },
    });
  } finally {
    await page.close();
  }
