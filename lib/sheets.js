...
const APP_SHEET_SPECS = {
  ...
  YouthGroups:        ['id', 'youth_group_name', 'church_name', 'address', 'city', 'state', 'zip', 'lat', 'lng', 'category', 'primary_contact_id', 'primary_contact_name', 'primary_contact_phone', 'primary_contact_email', 'tags', 'notes', 'created_at', 'updated_at']
};
