...
sheetsLib.ensureColumns('EventItinerary', ['ItemDate', 'SortOrder'])
  .catch(err => console.error('Could not add ItemDate/SortOrder columns to EventItinerary:', err.message));
